...
// `;
//
// async function getTemplateTeacher(templateId: string): Promise<EvalTemplate> {
...
//   return result.data.getEvalTemplate.teacher.email;
// }
//
// export async function GET(request: Request, { params: { groupId } }) {
